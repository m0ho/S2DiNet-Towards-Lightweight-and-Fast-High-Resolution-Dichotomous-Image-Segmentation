...
if __name__ == "__main__":
    ...
    print(DatasetName,MethodName)
    root_preds_path = r"/workspace/evaluation/Results/"+DatasetName+"/"+MethodName
    gt_path = r"/workspace/evaluation/GroundTruth/"+DatasetName
