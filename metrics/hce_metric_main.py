...
def relax_HCE(gt, rs, gt_ske, relax=5, epsilon=2.0):
    ...
    # gt_ske = gt_ske>128    # print("max(gt_ske): ", np.amax(gt_ske))
...
def main():
    ...
    DatasetName = "DIS-TE1"
    print(DatasetName)
    gt_root = r"/workspace/evaluation/GroundTruth/"+DatasetName
    gt_ske_root = ""
    pred_root = r"/workspace/evaluation/Results/"+DatasetName+"/"+MethodName
